...
export var main = function () {
    ...
    function createScene() {
        ...
        ground.material.diffuseTexture = new BABYLON.Texture("src/static/3d/Resources/slack-imgs.com.jpg", scene);
    ...
    function createSky(){
        ...
        skyboxMaterial.reflectionTexture = new BABYLON.CubeTexture("src/static/3d/skybox/ely_lakes/lakes", scene); //["_px.tga", "_py.tga", "_pz.tga", "_nx.tga", "_ny.tga", "_nz.tga"]);
    ...
    function loadModel(a_options, a_loader) {
        var task = a_loader.addMeshTask(a_options.taskname, "", "src/static/3d/", a_options.filename);
        /**
         *
