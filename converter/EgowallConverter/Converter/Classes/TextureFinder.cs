    ...
    class TextureFinder
    {
        ...
        public bool TryFindFiles( string a_inputFile, string a_targetDirectory)
        {
            ...
            if (!HasFiles( a_targetDirectory ))
            {
                ...
                if (info.Name != "Col")
                {
                    return FindFiles(info, a_targetDirectory);                    
                }
            }
        ...
        public bool FindFiles( TextureInfo a_info, string a_targetDirectory)
        {
            string resourcesPath = a_info.FolderPath + "Resources";
            // If the resources folder exists in original folder
